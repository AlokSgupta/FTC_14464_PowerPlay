...
public class LeftA extends LinearOpMode {
    ...
    private static final int CYAN_MIN = 165;    // cyan ~188-197
                                                // yellow ~75-150
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double angle0 = Math.toRadians(29), angle1 = Math.toRadians(65);
        double distance = 14;
        ...
        do {
            ...
            telemetry.addData("Zone", zone);
            telemetry.update();
        } while (opModeIsActive() && (hsvValues[0] < 10 || getRuntime() < 12));
        ...
        if(zone == 1) {
            ...
            if(zone == 2) {
                TrajectorySequence trajSeq5 = drive.trajectorySequenceBuilder(startPose).forward(19).build();
                drive.followTrajectorySequence(trajSeq5);
            }
            drive.turn(Math.toRadians(100)); // turn left
        }
